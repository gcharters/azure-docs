...
* [Open Liberty](https://openliberty.io): Open Liberty is an Eclipse licensed IBM Open Source project that implements the Eclipse MicroProfile specifications and is also Java/Jakarta EE compatible. Open Liberty is fast to start up with a low memory footprint and supports live reloading for quick iterative development. It is simple to create just enough runtime for your application choosing features from the latest versions of MicroProfile and Java/Jakarta EE. Zero migration lets you focus on what's important to your business, not the APIs changing under you.
* [WebSphere Liberty](https://www.ibm.com/cloud/websphere-liberty): IBM WebSphere Liberty is a commercial offering of the Liberty server built on the upstream open source Open Liberty runtime.  It provides service and support for production deployments (including production deployments of Open Liberty), as well as providing older Java EE APIs to help with modernization of older Java EE applications to the Cloud.
